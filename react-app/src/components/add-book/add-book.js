                    ...
                    <div className ="row mx-5">
                        ...
                        <form onSubmit={saveBook}>
                            <div className="col-10">
                                ...
                                <input type="text" name="pageCount" onChange={onChange} className="form-control" id="pagecountFormInput"/>

                                <label for="publisherFormInput" className="form-label mt-3">Publisher</label>
                                <input type="text" name="publisher" onChange={onChange} className="form-control" id="publisherFormInput"/>

                                <label for="editionFormInput" className="form-label mt-3">Edition</label>
                                <input type="text" name="edition" onChange={onChange} className="form-control" id="editionFormInput"/>

                                <label for="isbnFormInput" className="form-label mt-3">ISBN</label>
                                <input type="text" name="isbn" onChange={onChange} className="form-control" id="isbnFormInput"/>

                                <label for="introductionFormInput" className="form-label mt-3">Introduction</label>
                                <textarea name="introduction" onChange={onChange} className="form-control" id="introductionFormInput" rows="6"></textarea>                               

                                {/* file uploads */}
                                <div className="row mt-3">
                                    <div className="col-3">
                                        <label for="maincopyFormFile" className="form-label">Main Copy</label>
                                        <input name="mainCopy" onChange={onChange} className="form-control" type="file" id="maincopy"/>
                                    </div>
                                </div>
                                ...
                                <div className="row mt-3 mb-5">
                                    <div className="col-3">
                                        ...
                                        <input name="resourceImage" onChange={onChange} className="form-control" type="file" id="resourceImageFormFile"/>
                                    </div>
                                </div>
